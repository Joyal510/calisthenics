    ...
    <div>
      <div className="row gap-2">
        <div className="col-xs-6 col-sm-12 col-md-12 col-lg-5 col-xl-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">What is Calisthenics ?</h5>

              <p class="card-text">
                Calisthenics is a form of exercise that uses your <span class="fw-bold">body weight</span> as
                resistance. It includes movements such as push-ups, pull-ups,
